...
el=document.createElement("div");el.classList.add("eventlocation");el.innerHTML=a.location==missingEntrySymbol?"Ort unbekannt":a.location;document.getElementById("modal-body").appendChild(el);el=document.createElement("p");el.classList.add("eventabstract");el.innerHTML=a.description.replace(/(?:\r\n|\r|\n)/g,"<br>");document.getElementById("modal-body").appendChild(el);document.getElementById("modal-body").appendChild(closeModalButton());document.getElementById("event-modal").style.display="flex"}
