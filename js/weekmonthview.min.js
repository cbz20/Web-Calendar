let today=new Date,referenceDate=new Date,events=[],categoriesSelected=[],calendarName="",missingEntrySymbol="&#x2022;",categoriesAll,categoryColors,svgFiles,weekview=!0,is_mobile=window.matchMedia("(max-width: 1300px)").matches;
...
startDate:d,endDate:p,location:e,mainCategory:b,allCategories:k}}function displayCalendar(){weekview||is_mobile?drawWeekView():drawMonthView();drawToggleButtons();toggleMode()}function toggleMode(){let a=document.getElementById("togglemode");is_mobile?(a.innerHTML="Kalender im Desktopmodus betrachten",a.addEventListener("click",function(){is_mobile=!1;displayCalendar()})):(a.innerHTML="Kalender im Mobilmodus betrachten",a.addEventListener("click",function(){is_mobile=!0;displayCalendar()}))}
function drawWeekView(){var a=referenceDate.getDay();0==a&&(a=7);let b=new Date(referenceDate.valueOf());b.setDate(b.getDate()+1-a);b.setHours(0,0,0,0);let c=new Date(referenceDate.valueOf());c.setDate(c.getDate()+7-a);c.setHours(23,59,59,999);let d=new Date(b.valueOf());document.getElementById("calendar-header").innerHTML="";a=document.createElement("button");is_mobile?(a=document.createElement("div"),a.id="calendar-title",a.title="springe zur aktuellen Woche",a.addEventListener("click",function(f){BackToToday()}),
a.innerHTML=calendarName+"<br>Woche vom "+b.toLocaleString("de-DE",{month:"numeric",year:"numeric",day:"numeric"})+"\u00ad bis "+c.toLocaleString("de-DE",{month:"numeric",year:"numeric",day:"numeric"}),document.getElementById("calendar-header").appendChild(a),wrapper=document.createElement("div"),a=document.createElement("button"),a.classList.add("setting-buttons"),a.title="linke Pfeiltaste dr\u00fccken",a.innerHTML="<",a.addEventListener("click",function(){changeWeek(-1)}),wrapper.appendChild(a),
wrapper.classList.add("mobile-button-wrapper"),a=document.createElement("button"),a.classList.add("setting-buttons"),a.title="rechte Pfeiltaste dr\u00fccken",a.addEventListener("click",function(){changeWeek(1)}),a.innerHTML=">",wrapper.appendChild(a),document.getElementById("calendar-header").appendChild(wrapper)):(a=document.createElement("button"),a.classList.add("setting-buttons"),a.title="linke Pfeiltaste dr\u00fccken",a.innerHTML="< Vorherige Woche",a.addEventListener("click",function(){changeWeek(-1)}),
...
document.createElement("div");el.classList.add("location");el.innerHTML=a.location==missingEntrySymbol?"Ort unbekannt":a.location;document.getElementById("modal-body").appendChild(el);a.allCategories.forEach(b=>{el=document.createElement("button");el.classList.add("toggle-buttons","dummy-button");el.disabled=!0;el.innerHTML=b;categoriesAll.includes(b)?el.style.backgroundColor=categoryColors[b]:el.style.backgroundColor=categoryColors[a.mainCategory];document.getElementById("modal-body").appendChild(el)});
el=document.createElement("p");el.classList.add("abstract");el.innerHTML=linkifyStr(a.description,{className:"linkInAbstract"}).replace(/(?:\r\n|\r|\n)/g,"<br>");document.getElementById("modal-body").appendChild(el);document.getElementById("modal-body").appendChild(closeModalButton());document.getElementById("event-modal").style.display="flex"}
...
function accordionElement(a,b){return'<div class="accordion">\n        <div class="accordion-header" onclick="toggleAccordion(this)">'+a+'<span class="arrow"></span></div>\n        <div class="accordion-content">'+b+"</div>\n    </div>\n    "}function toggleAccordion(a){a.querySelector(".arrow");a.classList.contains("active")?a.classList.remove("active"):a.classList.add("active")}
function toggleAccordion(a){document.querySelectorAll(".accordion-header").forEach(c=>{c!==a&&(c.classList.remove("active"),c.nextElementSibling.style.maxHeight=null,c.nextElementSibling.style.padding="0 10px")});a.classList.toggle("active");var b=a.nextElementSibling;a.classList.contains("active")?(b.style.maxHeight="2000px",b.style.padding="10px",a.scrollIntoView({behavior:"smooth",block:"start"})):(b.style.maxHeight=null,b.style.padding="0 10px")}setInterval(updateToday,6E4);
