...
b+=c,b+=": </b>",b+=copyButton(links[c].replace(/public\//g,"").replace(/.ics/g,"/")),b+=links[c].replace(/public\//g,"").replace(/.ics/g,"/"),b+="</li>";document.getElementById("my-modal-body").innerHTML="";document.getElementById("my-modal-body").innerHTML+=accordionElement("Grundlegende Anzeigefunktionen des Kalenders","<p> \n\t<b>Zwischen Wochen- und Monatsansicht wechseln</b>\n\t</p>\n\t<p> \n\t\tKlicken Sie dazu den Schalter \n\t\t<button class='toggle-buttons setting-buttons dummy-button' disabled>\n\t\t<img src=\""+
