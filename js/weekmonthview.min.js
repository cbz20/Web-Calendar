...
function(){toggleWeekMonth()});a.appendChild(button);button=document.createElement("button");buttonImage=document.createElement("img");buttonImage.classList.add("svg-icon");buttonImage.src=svgFiles.save;button.classList.add("toggle-buttons","setting-buttons");button.title="kopiere alle Anzeigeeinstellungen in die URL\n(z.B. um sie als Lesezeichen im Browser zu speichern)";button.appendChild(buttonImage);button.addEventListener("click",function(){addParamsToURL()});a.appendChild(button);help=document.createElement("a");
help.title="Hilfe anzeigen";help.innerHTML="Hilfe";help.id="help";help.addEventListener("click",function(){showHelp()});a.appendChild(help)}
